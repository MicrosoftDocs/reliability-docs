Thank you for contributing to Azure reliability documentation. Before selecting the "Create pull request" button:

1. Enter a meaningful PR title, using a prefix if necessary, and the keywords "New" or "Update" to indicate the nature of the change. For example: "_Azure VMware Solution reliability guide - Update zone-down testing information_".

2. Please add a brief comment outlining the purpose of this PR:
[REPLACE-THIS-TEXT]

3. Add links to any relevant references such as Azure DevOps work items.
[DELETE-OR-REPLACE-THIS-TEXT]

All PRs to this repository are reviewed and merged by a human. Automatic merge is disabled on this repository for PRs, even with the qualifies-for-auto-merge label. Once you address all feedback on the PR, we'll merge it into the main branch.
...
## Guidance for all contributors
  ...
  | **PR build** | After you open your PR, and for each successive commit that you push to your branch, the publishing platform will run validation on the files in your pull request. You can view a summary of and suggestions/warnings/errors inline on your pull request. We can't merge PRs until all build errors and most warnings are resolved. |
  ...
  | **Additional resources** | <ul><li>[Microsoft Learn contributor guide](https://review.learn.microsoft.com/help/contribute/?branch=main)</li></ul>
  | **Questions** | If you aren't sure how to proceed, contact [Niall Glynn and John Downs](https://teams.microsoft.com/l/chat/0/0?users=jodowns@microsoft.com,glynnniall@microsoft.com) from the Azure Patterns and Practices team. |
