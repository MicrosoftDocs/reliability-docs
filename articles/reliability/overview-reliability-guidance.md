...
description: See a list of reliability guides for Azure products and services. Learn about transient fault handling, availability zones, and multiregion support.
author: glynnniall
ms.service: azure
ms.topic: reference
ms.date: 01/15/2026
...
- *Resilience to region-wide failures* outlines whether the service provides multiregion capabilities, requirements to use those capabilities, how traffic is routed and data is replicated between regions, the region-down experience, failover and failback support, and how to deploy custom multiregion solutions.
