...
| [Azure API Center](/azure/api-center/frequently-asked-questions) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure App Configuration](./reliability-app-configuration.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Automation](/azure/automation/automation-availability-zones) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
| [Azure Backup](reliability-backup.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Cache for Redis](/azure/redis/migrate-cache-redis-zones) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: |
| [Azure Chaos Studio](./reliability-chaos-studio.md) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Cosmos DB](./reliability-cosmos-db.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Databricks Classic: Compute Plane](./reliability-databricks.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes (Azure-selected zone)" border="false"::: [(Azure-selected zone)](/azure/virtual-machines/create-portal-availability-zone#create-a-zonal-virtual-machine-in-an-azure-selected-zone) | |
| [Azure Databricks Classic: Control Plane](./reliability-databricks.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
| [Azure Databricks Serverless](./reliability-databricks.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
| [Azure DDoS Protection](./reliability-ddos-protection.md) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Disk Storage](./reliability-storage-disk.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: |
...
| [Azure Elastic SAN](./reliability-elastic-san.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Foundry](/azure/foundry/how-to/high-availability-resiliency#design-for-high-availability) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure HDInsight](/azure/hdinsight/reliability-hdinsight#availability-zone-support) | | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: |
| [Azure IoT Hub](reliability-iot-hub.md) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
| [Azure IoT Hub device provisioning service](/azure/iot-dps/about-iot-dps) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Managed Grafana](./reliability-managed-grafana.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Monitor Logs](./reliability-monitor-logs.md) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
| [Azure Monitor: Application Insights](./reliability-monitor-logs.md) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Red Hat OpenShift](/azure/openshift/openshift-faq#can-a-cluster-be-deployed-across-multiple-availability-zones) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
| [Azure Route Server](/azure/route-server/route-server-faq) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure SignalR Service](./reliability-signalr.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
| [Azure Site Recovery](./reliability-site-recovery.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
...
| [Azure Virtual Desktop: Host Pool](/azure/virtual-desktop/deploy-azure-virtual-desktop) | | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: |
| [Azure Virtual Machine Scale Sets](./reliability-virtual-machine-scale-sets.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: |
...
| [Azure Web PubSub](./reliability-web-pubsub.md#resilience-to-availability-zone-failures) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
