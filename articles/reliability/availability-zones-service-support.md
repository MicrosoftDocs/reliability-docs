...
| [Azure Event Grid](reliability-event-grid.md#resilience-to-availability-zone-failures-availability-zone-support) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | |
