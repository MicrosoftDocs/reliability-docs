...
* **BCDR as default**: If a region is [paired](../regions-list.md) with a [region that supports Power BI](/fabric/admin/region-availability), disaster recovery capabilities are included by default. You don't need to opt in or activate this feature separately. 
