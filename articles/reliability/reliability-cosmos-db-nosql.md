...
* The affected region is disconnected and marked offline. The [Azure Cosmos DB SDKs](/azure/cosmos-db/nosql/sdk-dotnet-v3) redirect read calls to the next available region in the preferred region list.
